...
const helpers = {
    ...
    async reload (page, options = {}) {
        await page.reload({
            waitUntil: options.waitUntil === 'networkidle0' ? 'networkidle' : options.waitUntil || 'networkidle',
...
async function runTests () {
    ...
    try {
        ...
        try {
            ...
            page.waitForSelector = (selector, options = {}) => helpers.waitForSelector(page, selector, options)
            page.waitForTimeout = (ms) => helpers.waitForTimeout(page, ms)
            page.reload = (options = {}) => helpers.reload(page, options)
